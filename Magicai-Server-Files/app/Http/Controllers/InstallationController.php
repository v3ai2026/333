...
class InstallationController extends Controller
{
    ...
    public function install(Request $request)
    {
        ...
        if (! Schema::hasTable('activity')) {
            return 'You are using Plesk for moda.STUDIO. It requires MariaDB 10.X or Mysql 5.6,5.7. Please check your mariaDB or Mysql version. After upgrade your mariadb or mysql please reset the table.';
        }
    ...
    public function upgrade()
    {
        ...
        if ($version > $currentVersion) {
            if (! Schema::hasTable('migrations')) {
                return 'moda.STUDIO is not installed. Install it first. Go to /install';
            }
            ...
            return "<p>moda.STUDIO Updated to the version: $version you can go home. The 1.20 update is for testing. If you want to contribute in this system please go to admin and update menu to test autoupdating system.
...
";
    ...
    {
        // Security check: Verify user is authenticated and has admin privileges
        if (!auth()->check() || !auth()->user()?->isAdmin()) {
        ...
        // Always use true - password parameter removed for security
        InstallationHelper::runInstallation(true);
        ...
        return "<p>moda.STUDIO Updated to the version: $version. Please don't forget to clear your browser cache. You can close this window.";
    }
